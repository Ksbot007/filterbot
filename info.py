...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "@ksmoviesbot <code>{file_name}</code> ")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "@ksmoviesbot <code>{file_name}</code>  ")
